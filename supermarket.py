...
# - General
    ...
    tabs= st.tabs(['None' , 'total revenue generated by each city','most popular Product','average Tax (5%)','total quantity sold','highest number of unique customers'])

#1-What is the total revenue generated by each city?
    with tabs[1]:
        st.title('1-What is the total revenue generated by each city?')
    ...
    with tabs[2]:
        st.title('2 - What is the most popular Product line based on the number of invoices?')
        q2 = px.histogram(df,y='Quantity' , x='Product line',color='Product line',
                     barmode='group' , text_auto=True , pattern_shape='Product line').update_xaxes(categoryorder='total descending')
        st.plotly_chart(q2)
        
    # 3-What is the average Tax (5%) paid by customers in each City?
    with tabs[3]:
        st.title('3-What is the average Tax (5%) paid by customers in each City?')
        q3 = px.box(df , x='Tax 5%')
        st.plotly_chart(q3)
        
    # 4- What is the total quantity sold in each Product line?
    with tabs[4]:
        st.title('4- What is the total quantity sold in each Product line?')
    ...
    with tabs[5]:
        st.title('5-Which City has the highest number of unique customers?')
...
#########################
    ...
    tabs2 = st.tabs(['None' , 'average Unit price of items' , ' Product line is most popular' , 'proportion of invoices by Gender'])
# 6- What is the average Unit price of items purchased by male and female customers?
    with tabs2[1]:
        st.title('6- What is the average Unit price of items purchased by male and female customers?')
...
# 7-Which Product line is most popular among male customers? How about female customers?
    with tabs2[2]:
        st.title('7-Which Product line is most popular among male customers? How about female customers?')
...
#8-What is the proportion of invoices by Gender in each City?
    with tabs2[3]:
        st.title('8-What is the proportion of invoices by Gender in each City?')
...
##########################
    ...
    tabs3 = st.tabs(['None' , 'total revenue generated by Customer','the highest sales for "Member" customers','average purchase Quantity'])

# 9-What is the total revenue generated by Customer type (e.g., "Member" vs "Normal")?
    with tabs3[1]:
        st.title('9-What is the total revenue generated by Customer type (e.g., "Member" vs "Normal")?')
...
# 10-Which City has the highest sales for "Member" customers? How about "Normal" customers?
        st.title('10-Which City has the highest sales for "Member" customers? How about "Normal" customers?')
...
# 11-What is the average purchase Quantity for each Customer type?    
    with tabs3[3]:
        st.title('11-What is the average purchase Quantity for each Customer type?    ')
...
#######################################
    ...
    tabs4 = st.tabs(['None' , 'average Unit price of products','most revenue'])
...
#13-Which Product line generates the most revenue across all City?
    with tabs4[2]:
        st.title('13-Which Product line generates the most revenue across each City?')
        q13 = px.histogram(df , x='City', y='Tax 5%' , text_auto=True , color='Product line' , barmode='group') # for each city
        st.plotly_chart(q13)
        st.title('13-Which Product line generates the most revenue across all City?')
...
################################
    ...
    tabs5 = st.tabs(['Noe','highest total Tax','Tax (5%) collected from each Product'])

# 14-Which City generates the highest total Tax (5%) from all sales?
    with tabs5[1]:
        st.title('14-Which City generates the highest total Tax (5%) from all sales?')
...
#15-What is the total Tax (5%) collected from each Product line?
    with tabs5[2]:
        st.title('15-What is the total Tax (5%) collected from each Product line?')
...
###################
    ...
    tabs6 = st.tabs(['None' , 'average Quantity of products' , 'highest quantity sold'])

# 16-What is the average Quantity of products sold per invoice in each City?
    with tabs6[1]:
        st.title('16-What is the average Quantity of products sold per invoice in each City?')
        q16 =px.box(df , x='Quantity' , y='Product line')
        st.plotly_chart(q16)

# 17-highest quantity sold in each city?
    with tabs6[2]:
        st.title('17-highest quantity sold in each city?')
        q17 = px.histogram(df , y='Quantity',x='City',color='Product line',
                           barmode='group',pattern_shape='Product line' ,text_auto=True)
        st.plotly_chart(q17)
    pass
######################################
# - summary
...
# 18- What is the highest total price recorded in the dataset, and City, and Customer type does it belong to?
    st.title('18- What is the highest total price recorded in the dataset, and City, and Customer type does it belong to?')
